...
import { EventSourceMappingOptions } from './event-source-mapping'
...
export abstract class StreamEventSource implements lambda.IEventSource {
  ...
  protected enrichMappingOptions(options: EventSourceMappingOptions): lambda.EventSourceMappingOptions {
    return {
      ...options,
